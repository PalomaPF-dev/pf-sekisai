...
export const config = {
  matcher: [
    '/((?!login|password-reset|first-login|api/auth|api/provision|api/password-reset|api/first-login|api/sync|api/account|api/push|_next/static|_next/image|favicon.ico|.*\\.(?:png|jpg|jpeg|gif|svg|ico)).*)',
  ],
};
