...
export const config = {
  matcher: [
     ...
     */
    '/((?!login|register|privacy|api/auth|api/register|api/sync|api/account|api/push|api/subscription|api/webhooks|_next/static|_next/image|favicon.ico|.*\\.(?:png|jpg|jpeg|gif|svg|ico)).*)',
  ],
};
