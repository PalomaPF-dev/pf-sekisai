...
export const config = {
  matcher: [
    '/((?!login|register|privacy|contact|terms|pricing|api/auth|api/register|api/sync|api/account|api/push|api/contact|_next/static|_next/image|favicon.ico|.*\\.(?:png|jpg|jpeg|gif|svg|ico)).*)',
  ],
};
