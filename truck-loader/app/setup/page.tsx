...
export default function SetupWizard() {
  ...
  return (
    <div className="mx-auto max-w-4xl p-4 sm:p-6">
      ...
      <p className="mt-0.5 text-xs text-slate-500">順番に入力するだけで、積載計画・AI提案まで使える状態になります。</p>
        ...
        {step === 7 && (
          <div>
            ...
            <div className="mt-5 flex flex-wrap gap-3">
              <Link href="/loading-plan" className="rounded-lg bg-indigo-600 px-4 py-2 text-sm font-semibold text-white hover:bg-indigo-700">🚛 積載計画・AI提案を見る</Link>
