  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-10 text-gray-800 leading-relaxed">
      ...
      <ul className="mt-2 list-disc pl-6 space-y-1">
        ...
        <li>Pro機能（複数拠点の積載計画、CSVインポート/エクスポート、PDF出力、クラウド同期、バーコード積込確認）は、<strong>会社単位の法人契約（アプリ外でのお申し込み・請求書/銀行振込）</strong>でご利用いただけます。料金・条件は<a className="text-blue-600 underline" href="/pricing">料金ページ</a>または当方へのお問い合わせにてご案内します。</li>
      </ul>
