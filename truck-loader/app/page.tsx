  ...
  return (
    <div className="max-w-screen-xl mx-auto px-4 py-6">
      ...
      <section className="mb-8">
        <div className="flex items-center justify-between mb-3">
          <div>
            ...
            <p className="text-xs text-slate-400 mt-0.5">
              ...
              {hasPlannedSales && <><span className="text-rose-500 font-medium"> 予定出荷</span> ／</>}
              <span className="text-emerald-600 font-medium"> 積載計画</span> ／
              <span className="text-brand-600 font-medium"> 出荷後在庫</span>
            </p>
          </div>
        ...
        {confirmed && (
          <div className="mb-3 px-4 py-2.5 bg-emerald-50 border border-emerald-200 rounded-lg text-sm text-emerald-700 flex items-center gap-2">
            ...
            {(() => {
              ...
              return (
                <table className="text-xs border-collapse bg-white"
                  style={{ minWidth: `${360 + activeWarehouses.length * colsPerWh * 64}px` }}>
                  <thead>
