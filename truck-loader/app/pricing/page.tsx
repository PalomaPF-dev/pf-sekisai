  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800">
      ...
      <div className="max-w-2xl mx-auto px-5 py-10">
        ...
        {/* 料金カード（価格・カード決済はクライアント側でWeb確定時のみ描画。ネイティブ/静的HTMLには載せない） */}
        <PricingCards />
        ...
        <div className="mt-6 bg-white border border-gray-200 rounded-xl p-5 text-center">
          ...
          <Link href="/contact" className="inline-block mt-3 rounded-lg bg-indigo-600 px-6 py-3 text-sm font-bold text-white hover:bg-indigo-700">
            お問い合わせフォーム
          </Link>
        </div>
